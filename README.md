...
> :warning: Do you prepare __TM Robot__ ready ? Make sure that TM Robot's operating software (__TMflow__) system/network settings are ready and the _Listen task_ project is running. 
>
> ```bash
...
> <br/>
> &spades; demo_leave_listen_node:<br/>
