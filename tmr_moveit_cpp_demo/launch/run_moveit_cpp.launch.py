...
def generate_launch_description():
    ...
    fake_joint_driver_node = Node(
        ...
        parameters=[
            ...
            os.path.join(get_package_share_directory("tmr_moveit_cpp_demo"), "config", "tmr_controllers.yaml"),
            os.path.join(get_package_share_directory("tmr_moveit_cpp_demo"), "config", "tmr_start_positions.yaml"),
            robot_description]
        )
    '''

    return LaunchDescription([ tmr_driver_node, static_tf, robot_state_publisher, rviz_node, run_moveit_cpp_node ])
