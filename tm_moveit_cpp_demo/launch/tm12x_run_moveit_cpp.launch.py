...
def generate_launch_description():
    ...
    # Use URDF file: tm12x-nominal.urdf to do moveit demo
    # robot_description_config = load_file('tm_description', 'urdf/tm12x-nominal.urdf')
    ...
    robot_description_semantic_config = load_file('tm_moveit_config_tm12x', 'config/tm12x.srdf')
    robot_description_semantic = {'robot_description_semantic' : robot_description_semantic_config}

    kinematics_yaml = load_yaml('tm_moveit_config_tm12x', 'config/kinematics.yaml')
    ...
    ompl_planning_yaml = load_yaml('tm_moveit_config_tm12x', 'config/ompl_planning.yaml')
