...
def generate_launch_description():
    ...
    # Use URDF file: tm14x-nominal.urdf to do moveit demo
    # robot_description_config = load_file('tm_description', 'urdf/tm14x-nominal.urdf')
    ...
    robot_description_semantic_config = load_file('tm_moveit_config_tm14x', 'config/tm14x.srdf')
    robot_description_semantic = {'robot_description_semantic' : robot_description_semantic_config}

    kinematics_yaml = load_yaml('tm_moveit_config_tm14x', 'config/kinematics.yaml')
    ...
    ompl_planning_yaml = load_yaml('tm_moveit_config_tm14x', 'config/ompl_planning.yaml')
