...
def generate_launch_description():
    ...
    robot_description_semantic_config = load_file('tm_moveit_config_tm5x_900', 'config/tm5x-900.srdf')
    robot_description_semantic = {'robot_description_semantic' : robot_description_semantic_config}

    kinematics_yaml = load_yaml('tm_moveit_config_tm5x_900', 'config/kinematics.yaml')
    ...
    ompl_planning_yaml = load_yaml('tm_moveit_config_tm5x_900', 'config/ompl_planning.yaml')
