...
def generate_launch_description():
    ...
    # Use URDF file: tm5x-900-nominal.urdf to do moveit demo
    # robot_description_config = load_file('tm_description', 'urdf/tm5x-900-nominal.urdf')
    ...
    robot_description_semantic_config = load_file('tm_moveit_config_tm5x-900', 'config/tm5x-900.srdf')
    robot_description_semantic = {'robot_description_semantic' : robot_description_semantic_config}

    kinematics_yaml = load_yaml('tm_moveit_config_tm5x-900', 'config/kinematics.yaml')
    ...
    ompl_planning_yaml = load_yaml('tm_moveit_config_tm5x-900', 'config/ompl_planning.yaml')
